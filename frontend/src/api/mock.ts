  ...
  processes: [
    {
      ...
      snapshot: {
        sources: [
          { id: 0, path: "src/rpc/demo.rs", line: 42, krate: "lab-server" },
          { id: 1, path: "src/rpc/demo.rs", line: 45, krate: "lab-server" },
          { id: 2, path: "src/rpc/demo.rs", line: 18, krate: "lab-server" },
          { id: 3, path: "src/rpc/demo.rs", line: 20, krate: "lab-server" },
          { id: 4, path: "src/state.rs", line: 12, krate: "lab-server" },
          { id: 5, path: "src/dispatch.rs", line: 67, krate: "lab-server" },
          { id: 6, path: "src/dispatch.rs", line: 68, krate: "lab-server" },
          { id: 7, path: "src/store.rs", line: 104, krate: "lab-server" },
        ],
        scopes: [],
        events: [],
        entities: [
        ...
        edges: [
          { src: "resp_sleepy", dst: "lock_state", source: 1, kind: "waiting_on" },
          { src: "lock_state", dst: "ch_rx", source: 4, kind: "waiting_on" },
          { src: "ch_rx", dst: "resp_sleepy", source: 6, kind: "waiting_on" },
          { src: "ch_tx", dst: "ch_rx", source: 5, kind: "paired_with" },
          { src: "req_sleepy", dst: "resp_sleepy", source: 0, kind: "paired_with" },
          { src: "req_ping", dst: "resp_ping", source: 2, kind: "paired_with" },
          { src: "req_ping", dst: "lock_state", source: 2, kind: "polls" },
          { src: "future_store", dst: "ch_rx", source: 7, kind: "polls" },
        ],
      },
    },
    {
      ...
      snapshot: {
        sources: [
          { id: 0, path: "src/server/limits.rs", line: 28, krate: "lab-loader" },
          { id: 1, path: "src/lifecycle.rs", line: 15, krate: "lab-loader" },
          { id: 2, path: "src/config.rs", line: 8, krate: "lab-loader" },
          { id: 3, path: "src/bootstrap.rs", line: 55, krate: "lab-loader" },
          { id: 4, path: "src/config.rs", line: 22, krate: "lab-loader" },
          { id: 5, path: "src/net/peer.rs", line: 31, krate: "lab-loader" },
        ],
        scopes: [],
        events: [],
        entities: [
        ...
        edges: [
          { src: "oncecell_config", dst: "file_config", source: 2, kind: "waiting_on" },
          { src: "cmd_migrate", dst: "oncecell_config", source: 3, kind: "polls" },
          { src: "net_peer", dst: "sem_conns", source: 5, kind: "polls" },
          { src: "sem_conns", dst: "notify_shutdown", source: 0, kind: "polls" },
        ],
      },
    },
  ],
