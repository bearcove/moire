...
pub fn __init_from_macro() {
    moire_runtime::init_runtime_from_macro();
}
...
macro_rules! facade {
    () => {
        ...
        pub mod moire {
            ...
            pub fn rpc_response(
                method: impl Into<String>,
            ) -> $crate::EntityHandle<$crate::moire_types::Response> {
